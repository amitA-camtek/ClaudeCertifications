...
| 0:10–0:55 | Theory | Hub-and-spoke architecture, coordinator role, subagent context isolation |
| 0:55–1:40 | Theory | `Task` tool for subagent spawning; `allowedTools` must include `'Task'` |
...
| 0:30–1:00 | Theory | Task decomposition pitfalls (overly narrow → coverage gaps) |
