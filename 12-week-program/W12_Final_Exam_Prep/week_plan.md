...
| Time | Block | Task |
|---|---|---|
| 0:00–0:10 | Warmup | Full-sweep cold recall of **⭐-starred cards only** across W01–W11 `weak_spots.md` per [../spaced_repetition_schedule.md](../spaced_repetition_schedule.md). Also pull 2 weakest domains from [W11 notes/weak_spots.md](../W11_Integration_Hands_On/notes/weak_spots.md) |
...
| 2:15–2:30 | Final | Light review of key concepts — [reference.md](reference.md) fast-recap sections + [exercises/domain_cheatsheet.md](exercises/domain_cheatsheet.md); run the **adjacent-concept drill** ([exercises/adjacent_concepts_drill.md](exercises/adjacent_concepts_drill.md)) with pairs covered and self-test; write final `notes/exam_day_cheatsheet.md` |
